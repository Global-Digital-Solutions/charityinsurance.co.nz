...
export default function ComparePage() {
  return (
    <>
      <section className="relative min-h-[260px] flex items-end" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1920&q=80)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
