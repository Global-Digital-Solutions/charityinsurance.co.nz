...
export default function OrganisationsPage() {
  return (
    <>
      <section className="relative min-h-[600px] flex items-end" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1920&q=80)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
